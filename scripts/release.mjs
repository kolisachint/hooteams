...
function getVersion() {
	const pkg = JSON.parse(readFileSync(join(repoRoot, "packages/bridge/package.json"), "utf-8"));
	return pkg.version;
}
...
function bumpOrSetVersion(target) {
	...
	run(`bunx shx rm -rf node_modules packages/*/node_modules bun.lock && bun install`);
	return getVersion();
}
